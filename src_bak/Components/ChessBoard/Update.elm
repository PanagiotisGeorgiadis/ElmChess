...
getInitialWhitePlayerState =
    ...
    List.concat
        [ Pawn.initialWhitePiecesState
        , Bishop.initialWhitePiecesState
        , Knight.initialWhitePiecesState
        , Rook.initialWhitePiecesState
        , Queen.initialWhitePiecesState
        , King.initialWhitePiecesState
        ]
...
getInitialBlackPlayerState =
    List.concat
        [ Pawn.initialBlackPiecesState
        , Bishop.initialBlackPiecesState
        , Knight.initialBlackPiecesState
        , Rook.initialBlackPiecesState
        , Queen.initialBlackPiecesState
        , King.initialBlackPiecesState
        ]
